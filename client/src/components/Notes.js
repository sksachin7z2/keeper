...
<div  className="modal fade" id="exampleModal" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div className="mb-3">
  <label htmlFor="edescription" className="form-label darkmode ">Description</label>
    ...
    <input type="text" value={note.etag} className="form-control" id="etag" name="etag" onChange={onchange} />
      ...
      <div style={{backgroundColor:"rgb(49, 51, 85)",color:"white"}} className="modal-footer">
        ...
        <div className="container">
           ...
           <h2 className='darkmode'>Your Notes</h2>
           <div className="row my-3">
           <div className="container">
           {notes.length===0 && <p style={{color:"rgb(3, 255, 149)"}}> No notes to display</p>}</div>
           {notes.map((note)=>{
